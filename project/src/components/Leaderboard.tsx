      ...
      <div className="bg-[#161b22] border border-[#30363d] rounded-lg overflow-hidden">
        ...
        <div className="divide-y divide-[#30363d]">
          {mockLeaders.map((leader, index) => (
            <div key={leader.id} className="grid grid-cols-12 p-4 items-center hover:bg-[#1f2937] transition-colors">
              <div className="col-span-1 text-center">
                <div
                  className={`inline-flex items-center justify-center h-8 w-8 rounded-full text-white text-sm font-semibold ${index < 3 ? "bg-gradient-to-r from-[#00a8ff] to-[#00f5d4]" : "bg-[#21262d]"}`}
                >
                  {index + 1}
                </div>
              </div>
